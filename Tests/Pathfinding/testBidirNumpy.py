...
class testBidirNumpy(baseTest):
    ...
    def testBidirectionalBlowup10(self):
        sources = [
            self.unpack_filename('DeltaFiles/bidirectional_duplicate_blowup_10/Vland.sec'),
        ]
    ...
    def testBidirectionalBlowup11(self):
        sources = [
            self.unpack_filename('DeltaFiles/bidirectional_duplicate_blowup_11/Lishun.sec'),
        ]
    ...
    def testBidirectionalBlowup12(self):
        sources = [
            self.unpack_filename('DeltaFiles/bidirectional_duplicate_blowup_12/Magyar.sec'),
        ]
