...
class testStatCalcRegression(baseTest):
    ...
    def testStatsCalcReftSector(self) -> None:
        ...
        expected = {'TLmean': 0, 'TLstddev': 0, 'bases': NoNoneDefaultDict(int), 'code_counts': NoNoneDefaultDict(int),
                    ...
                    'maxPort': 'X', 'maxTL': 0, 'milBudget': 0, 'number': 122, 'passengers': 7817145, 'percapita': 4741,
                    'population': 80481, 'populations': NoNoneDefaultDict(Populations), 'port_size': NoNoneDefaultDict(int),
                    'primary_count': NoNoneDefaultDict(int), 'shipyards': 81, 'spa_people': 23600,
                    'star_count': NoNoneDefaultDict(int), 'stars': 172, 'sum_ru': 121636, 'trade': 143509760000,
                    'tradeDton': 3273503, 'tradeDtonExt': 0, 'tradeExt': 0, 'tradeVol': 143509760000, 'worlds': 1272,
                    '__dict__': {}}
